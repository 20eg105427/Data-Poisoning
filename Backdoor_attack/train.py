...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default="configs/Market1501/sbs_R101-ibn.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
...
def train_victim_model():
    ...
    clean_r10,ASR=evaluation.val_atk(trainer.model,cfg,normal_query,normal_loader,poison_query, poison_loader)
